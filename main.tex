...
% Q2: how does the autoregression model compare to persistence and random models?
% Q3: how does the performance of the autoregression model vary with season and time-of-day?
...
The primary objective of the present work is to empirically determine these timescales and characterize the time-domain performance of an autoregressive model. %%TODO%% "autoregressive" vs "autoregression"
...
\subsection{Future Work} %%TODO%% finalize this
